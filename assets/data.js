...
window.KB = {
  ...
  /* 產業報告節點。檔案位於 reports/。
     完整保留原始分析的敘事，跟拆散的零件/公司節點互補：
     - 零件/公司頁 = 網狀查詢用（現在在做什麼、跟誰有關）
     - 報告頁 = 整份分析的存檔（用一個視角完整讀一次） */
  reports: [
    { id:"semi-primer-v4", status:"done", name:"半導體產業鏈 Primer v4",
      period:"2026.07", topic:"產業入門", desc:"從三段結構到 AI 週期的完整入門讀本；把設計/代工/封測、類比 vs 數位、AI 拆解、供應鏈洞察串成一份地圖" },
  ]
};
