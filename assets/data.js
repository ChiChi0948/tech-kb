...
window.KB = {
  ...
  companies: [
    ...
    // 測試介面 (新分組)
    { id:"mpi",      group:"test",    status:"done", name:"旺矽",     code:"MPI",          desc:"探針卡龍頭;Broadcom/Marvell ASIC 幾乎獨家、MEMS 針自製" },
    { id:"winway",   group:"test",    status:"done", name:"穎崴",     code:"WinWay",       desc:"測試座專營;Nvidia/AMD/Google SLT 主供、Hypersocket 新動能" },
    { id:"chpt",     group:"test",    status:"done", name:"精測",     code:"CHPT",         desc:"Load Board 龍頭;Nvidia GPU 板從 25% 躍升 Rubin 世代 70%" },
    { id:"hongjing", group:"test",    status:"done", name:"鴻勁",     code:"Hongjing",     desc:"SLT Handler 唯一台廠;ATC 溫控讓 ASP 從 NT$6M 跳 NT$20M+" },
    { id:"yjc",      group:"test",    status:"done", name:"雍智科技", code:"YJC",          desc:"純板子設計、無自有產能;Google Humming Fish 訂單 re-rating" },
    // 封測
  ...
  parts: [
    ...
    // 半導體測試 (新增)
    { id:"semi-testing", status:"done", name:"半導體測試",    en:"Semiconductor Testing", desc:"WAT / CP / FT / Burn-in / SLT 五階段;AI 晶片時代測試從附屬變關鍵戰場" },
    { id:"probe-card",   status:"done", name:"探針卡",       en:"Probe Card", desc:"CP 階段的針床;CPC / Cobra / MEMS 三世代，3nm 以下必用 MEMS" },
    { id:"test-socket",  status:"done", name:"測試座",       en:"Test Socket", desc:"FT/SLT 夾住封裝晶片的插座;SLT 用量是 FT 的 4-5 倍" },
  ],
  groups: {
    ...
    test:   { name:"測試介面",  en:"Test Interface" },
